...
export class AppComponent {
  ...
  masterAnimalList: Animal[] = [
    ...
    new Animal('Hippopotamus', 'Hippy', 12, 'Omnivore', 'Africa', 10, 'Male', 'Swimming in shallow water', 'Sharing the watering hole with other animals', 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Hippopotamus_-_04.jpg/1200px-Hippopotamus_-_04.jpg', 'http://ichef.bbci.co.uk/wwfeatures/wm/live/624_351/images/live/p0/3d/tk/p03dtkw2.jpg', 'Today'),
    new Animal('Elephant', 'Elle', 25, 'Herbivore', 'Africa', 5, 'Female', 'Eating peanuts', 'Loud noises, mice', 'https://upload.wikimedia.org/wikipedia/commons/6/63/African_elephant_warning_raised_trunk.jpg', 'http://i.dailymail.co.uk/i/pix/2016/08/12/16/33AF370700000578-0-image-m-24_1471015298721.jpg', 'Today'),
  ];
